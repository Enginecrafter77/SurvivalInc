...
public class RenderHUD extends Gui {
	...
	private static final StatBar TEMPERATURE_BAR = new StatBar(StatType.TEMPERATURE, 100, 11, 80, 19, 14, new ResourceLocation(SchopCraft.MOD_ID, "textures/gui/tempbar.png"));
	private static final StatBar THIRST_BAR = new StatBar(StatType.THIRST, 100, 11, 80, 19, 14, new ResourceLocation(SchopCraft.MOD_ID, "textures/gui/thirstbar.png"));
	private static final StatBar SANITY_BAR = new StatBar(StatType.SANITY, 100, 11, 80, 19, 14, new ResourceLocation(SchopCraft.MOD_ID, "textures/gui/sanitybar.png"));
	private static final StatBar WETNESS_BAR = new StatBar(StatType.WETNESS, 100, 11, 80, 19, 14, new ResourceLocation(SchopCraft.MOD_ID, "textures/gui/wetnessbar.png"));
	private static final StatBar GHOST_BAR = new StatBar(StatType.GHOST, 200, 9, 187, 12, 10, new ResourceLocation(SchopCraft.MOD_ID, "textures/gui/ghostenergybar.png"));
	...
	public static void retrieveStats(float newTemperature, float newMaxTemperature, float newThirst, float newMaxThirst, float newSanity, float newMaxSanity, float newWetness, float newMaxWetness, boolean newIsGhost, float newGhostEnergy) {
	...
	public void renderOverlay(RenderGameOverlayEvent event) {
		...
		if (event.getType() == RenderGameOverlayEvent.ElementType.TEXT) {
			...
			if (GHOST_BAR.shouldBeDisplayed()) {
				...
				drawTexturedModalRect((screenWidth / 2)-93, screenHeight-50, GHOST_BAR.getMovingTextureX(), GHOST_BAR.getMovingTextureY(), GHOST_BAR.getMovingWidth(), GHOST_BAR.getFullHeight());
				drawTexturedModalRect((screenWidth / 2)-105, screenHeight-52, 0, 0, GHOST_BAR.getFullWidth(), GHOST_BAR.getFullHeight());
				drawCenteredString(mc.fontRenderer, GHOST_BAR.getTextToDisplay(), screenWidth / 2, screenHeight-60, Integer.parseInt("FFFFFF", 16));
			}
		}
	}
