...
public class ModSounds {
	...
	public static final SoundEvent FAN_WHOOSH = new SoundEvent(new ResourceLocation(SchopCraft.MOD_ID, "fan_whoosh"))
			.setRegistryName(SchopCraft.MOD_ID, "fan_whoosh");
