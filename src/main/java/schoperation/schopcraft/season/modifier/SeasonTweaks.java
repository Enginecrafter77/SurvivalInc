...
public class SeasonTweaks {
	...
	/*
	 * This class contains some miscellaneous season crap. Crap that doesn't
	 * need its own class, nor would it be nice cluttering WorldSeason.class
	 */

	/*
	 * These variables and this method changes grass colors as the seasons
	 * progress.
	 */
	// Grass colors.
	...
	public List<ItemStack> addBonusHarvest(List<ItemStack> drops)
	{
		...
		// From crops, there can be two items that can drop: the crop, and the
		// seed.
