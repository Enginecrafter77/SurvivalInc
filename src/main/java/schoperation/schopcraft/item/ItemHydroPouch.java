...
public class ItemHydroPouch extends Item {
	...
	public String getUnlocalizedName(ItemStack stack)
	{
		...
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "empty_hydropouch";
		}
		else if (stack.getMetadata() == 1)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "fresh_water_hydropouch";
		}
		else if (stack.getMetadata() == 2)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "dirty_water_hydropouch";
		}
		else if (stack.getMetadata() == 3)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "salt_water_hydropouch";
		}
		else if (stack.getMetadata() == 4)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "filtered_water_hydropouch";
		}
		else if (stack.getMetadata() == 5)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "cold_water_hydropouch";
		}
		else
		{
			stack.setItemDamage(0);
