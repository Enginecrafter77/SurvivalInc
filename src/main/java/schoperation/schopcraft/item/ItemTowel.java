...
public class ItemTowel extends Item {
	...
	public String getUnlocalizedName(ItemStack stack)
	{
		...
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "dry_towel";
		}
		else if (stack.getMetadata() == 1)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "partially_wet_towel";
		}
		else if (stack.getMetadata() == 2)
		{
			return "item." + SchopCraft.RESOURCE_PREFIX + "wet_towel";
		}
		else
		{
