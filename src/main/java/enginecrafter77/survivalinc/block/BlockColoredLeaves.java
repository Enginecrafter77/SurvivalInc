...
public class BlockColoredLeaves extends BlockLeaves {
	...
	public BlockColoredLeaves(EnumType treetype)
	{
		...
		this.setRegistryName(new ResourceLocation(SurvivalInc.MOD_ID, "leaves_" + treetype.getUnlocalizedName()));
		this.setUnlocalizedName(SurvivalInc.RESOURCE_PREFIX + "leaves_" + treetype.getUnlocalizedName());
