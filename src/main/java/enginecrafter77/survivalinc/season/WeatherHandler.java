...
public class WeatherHandler {
	...
	/*
	 * Handles the weather, every f*cking day. So the lying weather man on TV
	...
	// This doesn't actually change the weather, but randomizes it, and pushes
	// stuff to a method that does change it.
	public void makeItRain(World world, Season season)
	{

		// Time for more randomness, to determine whether to have a thunderstorm
		// or not.
		// Summer usually has more thunderstorms than other seasons, followed by
		// spring and autumn.
		...
		// Now the actual randomness. Gonna be a lot, so may as well make a new
		// generator.
		...
		SurvivalInc.logger.info("Rain is on the way in " + ticksUntilStart + " ticks.");
	...
	public void applyToRain(World world)
	{
		...
		// Logit
		SurvivalInc.logger.info("It's raining now. It's " + isThunder + " that it is thundering. It'll last for " + tickDuration + " ticks.");
	}
}