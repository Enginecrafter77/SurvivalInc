...
public class VignetteConfig {
	...
	public final String hotColor = "#f2541f";
	...
	public final String coldColor = "#2eecf0";
	...
	public final String dehydrationColor = "#9e9e9e";
}
