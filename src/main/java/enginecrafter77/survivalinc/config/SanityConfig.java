...
public class SanityConfig {
	...
	public final double startValue = 100D;
	...
	public final double wetnessAnnoyanceThreshold = 0.35D;
	...
	@Config.RangeDouble(min = 0, max = 100)
	public final double maxWetnessAnnoyance = 0.02D;
	...
	public final double darkSpookFactorBase = 0.05;
	...
	public final int comfortLightLevel = 4;
	...
	@Config.RangeDouble(min = 1E-3)
	public final double friendlyMobBonus = 0.006;
	...
	@Config.RangeDouble(min = 1E-3)
	public final double hostileMobModifier = 0.003;
	...
	public final double tamedMobMultiplier = 4;
	...
	@Config.RangeDouble(min = 0)
	public final double animalTameBoost = 20;
	...
	@Config.RangeDouble(min = 0, max = 1)
	public final double sleepResoration = 0.3;
	...
	@Config.RangeDouble(min = 0, max = 1)
	public final double hallucinationThreshold = 0.4;
	...
	@Config.RangeDouble(min = 0, max = 1)
	@Config.RequiresMcRestart
	public final double staticBuzzIntensity = 1;
	...
	public final int sleepDeprivationMin = 24000;
	...
	public final int sleepDeprivationMax = 120000;
	...
	@Config.RangeDouble(min = 0)
	public final double sleepDeprivationDebuff = 0.04;
}
