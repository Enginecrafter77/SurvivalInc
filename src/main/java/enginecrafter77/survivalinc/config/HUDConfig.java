...
public class HUDConfig {
	...
	public final double originX = 0.5D;
	
	@Config.LangKey("config.survivalinc.client.hud.originY")
	@Config.Comment("The X-axis origin of the HUD represented as a fraction from the current screen resolution")
	@Config.RangeDouble(min = 0, max = 1)
	public final double originY = 1D;
	...
	public final boolean stackSanityBar = true;
	...
	public final boolean stackHydrationBar = true;
	...
	public final StackingElementLayoutFunction sanityBarStack = StackingElementLayoutFunction.LEFT;
	...
	public final StackingElementLayoutFunction hydrationBarStack = StackingElementLayoutFunction.RIGHT;
	...
	public final ElementType sanityBarRenderTrigger = ElementType.HEALTH;
	...
	public final ElementType hydrationBarRenderTrigger = ElementType.FOOD;
	...
	public final Direction2D sanityBarDirection = Direction2D.RIGHT;
	...
	public final Direction2D hydrationBarDirection = Direction2D.LEFT;
	...
	public final int sanityBarX = -91;
	...
	public final int sanityBarY = -49;
	...
	public final int hydrationBarX = 10;
	...
	public final int hydrationBarY = -49;
	...
	public final int sanityBarCapacity = 10;
	...
	public final int sanityBarSpacing = -1;
	...
	@Config.RangeInt(min = 1)
	public final int hydrationBarCapacity = 10;
	...
	public final int hydrationBarSpacing = -1;
	...
	public final ElementType ghostEnergyRenderTrigger = ElementType.HEALTH;
}
