...
public class ItemCanteen extends Item {
	...
	/*
	 * A simple canteen for all your thirst needs. Ends up being full of code.
	 * Go figure.
	 */
	...
	public String getUnlocalizedName(ItemStack stack)
	{
		...
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "empty_canteen";
		}
		else if (stack.getMetadata() == 1)
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "fresh_water_canteen";
		}
		else if (stack.getMetadata() == 2)
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "dirty_water_canteen";
		}
		else if (stack.getMetadata() == 3)
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "salt_water_canteen";
		}
		else if (stack.getMetadata() == 4)
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "filtered_water_canteen";
		}
		else if (stack.getMetadata() == 5)
		{
			return "item." + SurvivalInc.RESOURCE_PREFIX + "cold_water_canteen";
		}
		else
		{
			stack.setItemDamage(0);
