...
public class ConfigPacket implements IMessageHandler<ConfigMessage, IMessage> {
	...
	public static class ConfigMessage implements IMessage {
		...
		public ConfigMessage(boolean enableGhost, boolean enableTemperature, boolean enableThirst, boolean enableSanity,
				boolean enableWetness, double temperatureScale, double thirstScale, double sanityScale,
				double wetnessScale, boolean aenableSeasons, boolean aenableDayLength, int winterLength,
				int springLength, int summerLength, int autumnLength)
		{
